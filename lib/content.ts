...
const zhContent = {
  ...
  culture: {
    heading: {
      ...
      description:
        "知识之外，SCIE 也期待每个人真实、同情、勤勉、热忱，让独立思考兼具原则、理解与行动。",
    },
    missionStatement:
...
const enContent = {
  ...
  culture: {
    heading: {
      ...
      description:
        "Beyond knowledge, SCIE asks each person to be sincere, compassionate, industrious and enthusiastic — principled in judgement, attentive to others and ready to act.",
    },
    missionStatement:
